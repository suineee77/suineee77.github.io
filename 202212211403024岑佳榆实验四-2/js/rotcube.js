...
function makeCube() {
    ...
    var vertexColors = [
        vec4.fromValues(0.0, 0.0, 0.0, 0.3),
        vec4.fromValues(1.0, 0.0, 0.0, 0.4),
        vec4.fromValues(1.0, 1.0, 0.0, 0.3),
        vec4.fromValues(0.0, 1.0, 0.0, 0.5),
        vec4.fromValues(0.0, 0.0, 1.0, 0.5),
        vec4.fromValues(1.0, 0.0, 1.0, 0.5),
        vec4.fromValues(0.0, 1.0, 1.0, 0.5),
        vec4.fromValues(1.0, 1.0, 1.0, 0.5)
    ];
